...
INSERT INTO hospitals (hospital_id, name, address, phone) VALUES
...
INSERT INTO doctors (doctor_id, name, specialty, hospital_id, email) VALUES
...
(1, 41, 26, '2026-04-16', 'Follow-up'),
(2, 113, 6, '2026-06-14', 'Checkup'),
(3, 66, 11, '2026-07-25', 'Emergency'),
(4, 120, 14, '2026-03-12', 'Emergency'),
(5, 63, 27, '2026-01-17', 'Consultation'),
(6, 14, 2, '2026-04-30', 'Consultation'),
(7, 39, 4, '2026-03-26', 'Emergency'),
(8, 71, 26, '2026-03-25', 'Consultation'),
(9, 38, 5, '2026-01-12', 'Follow-up'),
(10, 91, 28, '2026-05-10', 'Checkup'),
(11, 16, 23, '2026-04-21', 'Emergency'),
(12, 71, 8, '2026-06-26', 'Checkup'),
(13, 43, 2, '2026-06-18', 'Consultation'),
(14, 105, 27, '2026-04-06', 'Checkup'),
(15, 119, 19, '2026-01-11', 'Consultation'),
(16, 70, 21, '2026-08-30', 'Follow-up'),
(17, 27, 30, '2026-02-20', 'Follow-up'),
(18, 103, 30, '2026-07-04', 'Emergency'),
(19, 78, 18, '2026-05-20', 'Consultation'),
(20, 71, 20, '2026-01-08', 'Consultation'),
(21, 76, 22, '2026-07-02', 'Consultation'),
(22, 37, 3, '2026-08-31', 'Follow-up'),
(23, 57, 1, '2026-02-07', 'Consultation'),
(24, 12, 4, '2026-06-28', 'Emergency'),
(25, 77, 21, '2026-05-23', 'Emergency'),
(26, 103, 7, '2026-05-15', 'Checkup'),
(27, 50, 20, '2026-04-18', 'Checkup'),
(28, 41, 27, '2026-04-22', 'Follow-up'),
(29, 74, 19, '2026-02-12', 'Consultation'),
(30, 31, 4, '2026-03-31', 'Follow-up'),
(31, 38, 13, '2026-06-18', 'Follow-up'),
(32, 24, 3, '2026-07-31', 'Follow-up'),
(33, 25, 12, '2026-07-03', 'Emergency'),
(34, 106, 27, '2026-06-05', 'Emergency'),
(35, 24, 4, '2026-02-27', 'Emergency'),
(36, 5, 2, '2026-01-02', 'Checkup'),
(37, 79, 20, '2026-08-02', 'Emergency'),
(38, 85, 1, '2026-07-10', 'Emergency'),
(39, 34, 7, '2026-08-24', 'Checkup'),
(40, 61, 6, '2026-02-03', 'Follow-up'),
(41, 9, 23, '2026-08-31', 'Emergency'),
(42, 12, 4, '2026-03-24', 'Checkup'),
(43, 87, 16, '2026-05-21', 'Consultation'),
(44, 97, 7, '2026-01-05', 'Follow-up'),
(45, 17, 24, '2026-07-17', 'Emergency'),
(46, 113, 26, '2026-08-21', 'Emergency'),
(47, 20, 2, '2026-08-24', 'Checkup'),
(48, 119, 30, '2026-02-08', 'Checkup'),
(49, 5, 22, '2026-02-04', 'Emergency'),
(50, 108, 1, '2026-05-17', 'Consultation'),
(51, 11, 18, '2026-04-12', 'Consultation'),
(52, 115, 14, '2026-01-05', 'Emergency'),
(53, 90, 20, '2026-03-13', 'Checkup'),
(54, 119, 4, '2026-07-13', 'Emergency'),
(55, 107, 27, '2026-07-10', 'Follow-up'),
(56, 70, 9, '2026-03-01', 'Checkup'),
(57, 88, 3, '2026-08-17', 'Follow-up'),
(58, 51, 8, '2026-04-02', 'Checkup'),
(59, 108, 3, '2026-07-11', 'Emergency'),
(60, 91, 21, '2026-03-27', 'Emergency'),
(61, 68, 10, '2026-09-03', 'Consultation'),
(62, 36, 12, '2026-06-18', 'Checkup'),
(63, 67, 14, '2026-04-03', 'Follow-up'),
(64, 104, 6, '2026-01-17', 'Checkup'),
(65, 31, 2, '2026-02-16', 'Checkup'),
(66, 109, 17, '2026-08-24', 'Checkup'),
(67, 28, 15, '2026-05-24', 'Follow-up'),
(68, 115, 2, '2026-07-19', 'Checkup'),
(69, 87, 20, '2026-02-22', 'Follow-up'),
(70, 76, 4, '2026-05-11', 'Consultation'),
(71, 106, 23, '2026-05-30', 'Consultation'),
(72, 54, 13, '2026-08-22', 'Follow-up'),
(73, 75, 7, '2026-05-06', 'Checkup'),
(74, 36, 9, '2026-08-19', 'Emergency'),
(75, 58, 12, '2026-03-21', 'Emergency'),
(76, 64, 29, '2026-05-26', 'Checkup'),
(77, 85, 24, '2026-06-05', 'Checkup'),
(78, 83, 16, '2026-01-24', 'Consultation'),
(79, 90, 27, '2026-02-11', 'Emergency'),
(80, 118, 29, '2026-03-05', 'Checkup'),
(81, 102, 30, '2026-03-07', 'Consultation'),
(82, 46, 19, '2026-02-16', 'Follow-up'),
(83, 11, 6, '2026-04-15', 'Consultation'),
(84, 42, 23, '2026-01-25', 'Checkup'),
(85, 79, 22, '2026-02-07', 'Follow-up'),
(86, 15, 7, '2026-08-02', 'Consultation'),
(87, 63, 25, '2026-02-14', 'Checkup'),
(88, 76, 2, '2026-04-22', 'Checkup'),
(89, 81, 26, '2026-01-21', 'Checkup'),
(90, 43, 22, '2026-07-18', 'Follow-up'),
(91, 109, 6, '2026-03-08', 'Consultation'),
(92, 25, 28, '2026-06-14', 'Consultation'),
(93, 32, 6, '2026-07-24', 'Consultation'),
(94, 3, 11, '2026-04-14', 'Checkup'),
(95, 94, 17, '2026-02-21', 'Emergency'),
(96, 35, 9, '2026-02-09', 'Emergency'),
(97, 15, 4, '2026-04-25', 'Emergency'),
(98, 91, 20, '2026-05-29', 'Consultation'),
(99, 29, 30, '2026-06-14', 'Follow-up'),
(100, 48, 15, '2026-05-27', 'Follow-up')
;
...
INSERT INTO departments (department_id, hospital_id, name) VALUES
(1, 1, 'Cardiology'),
(2, 1, 'Radiology'),
(3, 1, 'Oncology'),
(4, 1, 'Pediatrics'),
...
INSERT INTO prescriptions (prescription_id, patient_id, doctor_id, medication_id, prescribed_date) VALUES
(1, 49, 3, 32, '2026-03-02'),
(2, 76, 3, 44, '2026-01-01'),
(3, 38, 26, 59, '2026-02-03'),
(4, 2, 3, 57, '2026-04-20'),
(5, 18, 7, 21, '2026-08-30'),
(6, 20, 24, 54, '2026-05-22'),
(7, 35, 8, 32, '2026-09-01'),
(8, 43, 2, 32, '2026-07-29'),
(9, 44, 13, 41, '2026-09-05'),
(10, 102, 1, 43, '2026-03-14'),
(11, 48, 4, 56, '2026-06-21'),
(12, 92, 13, 13, '2026-04-18'),
(13, 12, 18, 35, '2026-08-05'),
(14, 44, 17, 40, '2026-06-02'),
(15, 100, 10, 60, '2026-04-11'),
(16, 80, 15, 15, '2026-08-23'),
(17, 5, 30, 1, '2026-07-29'),
(18, 6, 16, 22, '2026-05-03'),
(19, 35, 26, 46, '2026-04-16'),
(20, 21, 19, 62, '2026-04-11'),
(21, 20, 23, 48, '2026-04-11'),
(22, 75, 22, 58, '2026-03-19'),
(23, 38, 7, 21, '2026-02-11'),
(24, 47, 14, 53, '2026-07-26'),
(25, 51, 3, 21, '2026-01-31'),
(26, 71, 12, 3, '2026-06-05'),
(27, 17, 8, 34, '2026-02-09'),
(28, 38, 9, 10, '2026-08-05'),
(29, 15, 19, 56, '2026-02-26'),
(30, 62, 25, 17, '2026-02-01'),
(31, 94, 6, 39, '2026-01-05'),
(32, 31, 14, 51, '2026-08-14'),
(33, 120, 7, 10, '2026-07-16'),
(34, 7, 12, 54, '2026-03-20'),
(35, 40, 4, 25, '2026-08-04'),
(36, 23, 3, 38, '2026-05-07'),
(37, 110, 27, 19, '2026-02-24'),
(38, 67, 28, 46, '2026-05-22'),
(39, 94, 28, 46, '2026-01-08'),
(40, 10, 23, 52, '2026-06-23'),
(41, 39, 1, 31, '2026-03-09'),
(42, 52, 29, 5, '2026-04-04'),
(43, 107, 17, 52, '2026-08-03'),
(44, 43, 15, 6, '2026-06-05'),
(45, 39, 25, 34, '2026-08-27'),
(46, 54, 22, 56, '2026-02-26'),
(47, 14, 7, 59, '2026-01-02'),
(48, 13, 4, 3, '2026-08-01'),
(49, 72, 16, 5, '2026-06-01'),
(50, 117, 13, 15, '2026-02-03'),
(51, 62, 9, 9, '2026-03-05'),
(52, 61, 7, 3, '2026-08-24'),
(53, 44, 21, 20, '2026-05-24'),
(54, 108, 2, 1, '2026-05-18'),
(55, 103, 26, 49, '2026-07-11'),
(56, 104, 7, 55, '2026-08-13'),
(57, 44, 20, 29, '2026-04-08'),
(58, 16, 5, 22, '2026-07-25'),
(59, 62, 4, 56, '2026-08-05'),
(60, 15, 7, 11, '2026-08-26'),
(61, 90, 15, 52, '2026-04-30'),
(62, 64, 13, 10, '2026-08-11'),
(63, 55, 12, 56, '2026-07-25'),
(64, 5, 18, 42, '2026-04-27'),
(65, 39, 27, 30, '2026-06-28'),
(66, 43, 5, 62, '2026-02-03'),
(67, 95, 4, 24, '2026-07-05'),
(68, 88, 20, 33, '2026-04-09'),
(69, 115, 16, 25, '2026-07-26'),
(70, 20, 5, 58, '2026-03-27'),
(71, 118, 19, 34, '2026-07-18'),
(72, 22, 13, 33, '2026-03-14'),
(73, 81, 21, 3, '2026-05-05'),
(74, 73, 22, 37, '2026-04-09'),
(75, 49, 14, 6, '2026-09-06'),
(76, 104, 29, 44, '2026-03-02'),
(77, 82, 17, 51, '2026-07-29');
...
INSERT INTO rooms (room_id, room_no, department_id, capacity) VALUES
(1, '101A', 3, 2),
(2, '101B', 3, 1),
(3, '102', 5, 2),
(4, '103', 5, 4),
...
-- Project--
-- Show room numbers and capacities in the Neurology department
select
   r.room_no,
   r.capacity
   from rooms as r
...
-- Show all appointments today onwards
...
select
    ...
    -- Patients with appointments in August 2026
    select
    p.name,
    p.phone,
    a.appointment_date
...
ORDER BY a.appointment_date;
 ...
 -- Medications containing "pain" or "infection" in description
...
-- Doctors who have not prescribed any medication
...
-- Patients who have been prescribed more than one medication
SELECT
    p.patient_id,
    p.name,
...
-- Number of appointments in each month in each hospital
...
SELECT
    ...
    DENSE_RANK() OVER (
        PARTITION BY da.hospital_id
        ORDER BY da.appointment_count DESC
    ) AS doctor_rank
FROM doctor_appointments da
JOIN hospitals h
    ON da.hospital_id = h.hospital_id
ORDER BY
    h.hospital_id,
    doctor_rank;


-- Doctors with zero appointments so far
...
-- Emergency appointments with patient DOB and age group
...
SELECT
    ...
    a.appointment_date,
    CASE
        WHEN TIMESTAMPDIFF(YEAR, p.dob, CURDATE()) <= 18
            THEN 'Pediatric'
        WHEN TIMESTAMPDIFF(YEAR, p.dob, CURDATE()) BETWEEN 19 AND 64
            THEN 'Adult'
        ELSE 'Geriatric'
    END AS age_group
FROM appointments a
...
-- Consultation appointments with cardiologists by age group
SELECT
    CASE
        WHEN TIMESTAMPDIFF(YEAR, p.dob, CURDATE()) <= 18
            THEN 'Pediatric'
...
GROUP BY age_group
ORDER BY
    FIELD(age_group, 'Pediatric', 'Adult', 'Geriatric');
    
    
    
-- Find the 3rd most frequently prescribed medication
...
-- Difference in days between appointment dates of returning patients
...
SELECT
    ...
    appointment_date AS current_appointment_date,
    DATEDIFF(
        appointment_date,
        previous_appointment_date
...
-- Department with the second-largest total room capacity in each hospital
...
-- Hospital with the most cardiologists

SELECT
    h.name AS hospital_name,
    COUNT(d.doctor_id) AS cardiologist_count
FROM hospitals h
JOIN doctors d
    ON h.hospital_id = d.hospital_id
